...
class TestTriangles(unittest.TestCase):
    ...
    def test_classifyTriangle(self): 
        ...
        self.assertEqual(classifyTriangle(6, 1, 2), 'NotATriangle')    #Side larger than the sum of other two
        self.assertEqual(classifyTriangle(6, 4, 2), 'NotATriangle')    #Side equal to the sum of other two
